...
class VendorActivityStatement(models.AbstractModel):
    """Model of Customer Activity Statement"""

    _name = 'report.vendor_activity_statement_ap.statement_vendor'
    ...
    def _get_account_initial_balance(self, company_id, partner_ids,
        ...
        FROM Q2""" % (partners, date_start,company_id)
        self.env.cr.execute(kk)
    ...
    def render_html(self, docids, data):
        ...
        return self.env['report'].render(
            'vendor_activity_statement_ap.statement_vendor', values=docargs)
